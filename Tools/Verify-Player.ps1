...
if (!$OutputDirectory) { $OutputDirectory=Join-Path $project 'Logs\PlayerRevision3Verification' }
New-Item -ItemType Directory -Force $OutputDirectory | Out-Null
$executable=Join-Path $project 'Builds\PlayerRevision3\RivetReach.exe'
