...
namespace RivetReach.Editor
{
    ...
    public static class StarterRecipeChecks
    {
        public static int Run(ItemRegistry items,RecipeRegistry registry)
        {
            ...
            Check(verified.Count==56&&registry.Recipes.Count(r=>!r.Id.StartsWith("rivet:industry_")&&!r.Id.StartsWith("rivet:farm_")&&r.Id!="rivet:wrench"&&r.Id!="rivet:compost_bin")==56,"The survival subset retains exactly the reviewed 56 recipes");
