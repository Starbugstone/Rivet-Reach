    ...
    public static class ItemPipeChecks
    {
        ...
        public static void Run()
        {
            ...
            foreach(byte crushed in new[]{IndustryId.CrushedCopper,IndustryId.CrushedIron,IndustryId.CrushedGold})
            {
                ...
                var p=IndustryDefinition.Neighbor(pipe.Position,face);var furnace=new FurnaceState(processing,Limit);world.Inventories[p]=furnace;
            ...
            }
            {
                ...
                Check(chest.Total(BlockId.Dirt)==8&&furnace.Slots[0].Id==IndustryId.CrushedIron&&furnace.Slots[0].Count==3&&furnace.Slots[1].Id==BlockId.Coal&&furnace.Slots[1].Count==2,"Mixed chest skips dirt and routes ingredients and fuel to separate slots");
                var port=(IItemPipeInventory)furnace;
            ...
            {
                var world=new World();var sim=new IndustrySimulation(world,Limit);var machine=sim.Add(origin,machineId);
