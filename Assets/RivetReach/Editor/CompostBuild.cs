...
namespace RivetReach.Editor
{
    public static class CompostBuild
    {
        public static void Prepare()
        {
            ...
            Add(CompostId.Bin,"compost_bin","Compost Bin");Add(CompostId.Compost,"compost","Compost");
            ...
            foreach(string key in new[]{"compost_bin","compost"})
            {
            ...
            foreach(byte id in new[]{CompostId.Bin,CompostId.Compost})
            {
            ...
            IndustryAssets.NormalizeModels(Resources.Load<Material>("Industry/Workshop"),new[]{"compost_bin","compost"});AssetDatabase.SaveAssets();
            CompostCatalog.Current.Validate(items);catalog.Compile(items);
            Directory.CreateDirectory("Logs/Compost");
            File.WriteAllLines("Logs/Compost/imports.txt",new[]{"compost_bin","compost"}.Select(key=>
            {
