    ...
    public sealed partial class Expedition
    {
        ...
        internal byte[] CaptureSave(SaveEntry entry)
        {
            ...
            return Saves.Encode(entry,w=>
            {
                ...
                Survival.WriteSave(w);Industry.Simulation.WriteSave(w);Items.WriteSave(w);Mobs.WriteSave(w);Animals.WriteSave(w);Beds.WriteSave(w);Weather.WriteSave(w);
            });
        }
        ...
        void RestoreSave(SaveReader r,SaveEntry entry)
        {
            ...
            var oldHunger=Hunger;var oldHealth=Health;var oldEquipment=Equipment;var oldSurvival=Survival;var oldIndustry=Industry;var oldFishing=Fishing;var oldAnimals=Animals;var oldBeds=Beds;var oldCrates=Crates;var oldWeather=Weather;
            ...
            try
            {
                ...
                Survival.ReadSave(r);Crates.Restored();Industry.Simulation.ReadSave(r);
                ...
                Items.ReadSave(r);Mobs.ReadSave(r);Animals.ReadSave(r);Beds.ReadSave(r);Weather.ReadSave(r,r.Format);SaveReader.Require(r.BaseStream.Position==r.BaseStream.Length,"Unexpected trailing save data.");
                if(r.Format<10)
                {
