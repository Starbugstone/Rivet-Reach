...
namespace RivetReach
{
    public sealed partial class GameUI
    {
        ...
        void BindRecipeDetails()
        {
            ...
            w.output.rectTransform.anchoredPosition=new Vector2(232,-centre-38);w.output.text=game.Registry.Get(recipe.Output.Id).displayName+(recipe.CompostPoints>0?" × 1–4 at 100%":" × "+recipe.Output.Count);
            w.method.text=recipe.CompostPoints>0?$"Adds {100f*recipe.CompostPoints/CompostCatalog.Current.pointsPerCompost:0.#}% · mix organics to reach 100%":grid!=null?grid.Kind==RecipeKind.Shapeless?"Any arrangement":grid.AllowsMirroring?"Shown layout or mirror":"Shown layout":
