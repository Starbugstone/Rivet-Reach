...
namespace RivetReach
{
    ...
    public sealed partial class RuntimeVerification : MonoBehaviour
    {
        ...
        IEnumerator Run()
        {
            ...
            if(Environment.GetCommandLineArgs().Contains("-rr-chicken-review")||Environment.GetCommandLineArgs().Contains("-rr-bed-review")||Environment.GetCommandLineArgs().Contains("-rr-crates-review"))game.World.ViewDistance=4;
            ...
            {report.workload="Normal and per-pile action pickup ranges, exact-item isolation, partial pickup, merging, delays, solid barriers and passable placed blocks";yield return ReviewPickupRanges();yield break;}
