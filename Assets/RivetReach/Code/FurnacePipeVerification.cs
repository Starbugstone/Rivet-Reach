...
namespace RivetReach
{
    public sealed partial class RuntimeVerification
    {
        IEnumerator ReviewFurnacePipes(BlockPos origin)
        {
            ...
            Mode(sim.At(fuelPipePos),2,PortRole.Output);
            ...
            sim=game.Industry.Simulation;furnace=game.Survival.At(fp).Furnace;
            Check(game.Survival.ActiveFurnaces>0&&furnace.Slots[0].Count==4&&furnace.Slots[1].Count==2,"Loaded furnace preserves items and resumes its active scheduler");
            ...
            Check(furnace.Slots[1].Count==1&&game.Survival.At(fp.Offset(0,2,0)).Storage.Total(BlockId.Dirt)==7,"Output extraction leaves unburned fuel and rejected source items intact");
            ...
            var mixed=game.Survival.At(fp.Offset(0,2,0)).Storage;mixed.Add(BlockId.RawCopper,4);mixed.Add(BlockId.RawIron,4);
