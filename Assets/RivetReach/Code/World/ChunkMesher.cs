...
namespace RivetReach
{
    ...
    public static class ChunkMesher
    {
        ...
        {
            var table=new bool[256];for(int i=0;i<table.Length;i++)table[i]=BlockId.Solid((byte)i)&&i!=BlockId.MobSpawner&&!IndustryId.Placed((byte)i)&&i!=IndustryId.DoorUpper&&!StarterStationVisuals.UsesModel((byte)i);return table;
        }
