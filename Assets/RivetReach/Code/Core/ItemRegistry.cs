...
namespace RivetReach
{
    ...
    public static class BlockId
    {
        ...
        public const byte LavaRock=37,MobSpawner=38;
        ...
        public static bool Mineable(byte id,ToolCapability tool,ToolTier tier=ToolTier.Diamond)=>id!=Air&&id!=Bedrock&&(Placeable(id)||BedId.Part(id)||id==IndustryId.DoorUpper||Ore(id)||id==Farmland||Crop(id))&&
    ...
    public sealed class ItemRegistry : ScriptableObject
    {
        ...
        public float MiningSeconds(byte blockId,ItemStack held)
        {
            ...
            bool effective=(BlockId.RequiredTier(blockId)!=ToolTier.None&&(tool&ToolCapability.Pickaxe)!=0)||
                ((blockId==BlockId.Log||blockId==BlockId.Planks||blockId==BlockId.Workbench||blockId==BlockId.Chest||BedId.Part(blockId)||IndustryId.DoorPart(blockId))&&(tool&ToolCapability.Axe)!=0)||
        ...
        public byte FistDrop(byte blockId){if(BedId.Part(blockId))return BedId.Bed;if(blockId==IndustryId.DoorUpper)return IndustryId.WoodenDoor;var item=Get(blockId);return item.fistDropId==0?blockId:item.fistDropId;}
    }
