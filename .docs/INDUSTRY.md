...
- Item sources retain one whole item per five ticks across all ends. Sources rotate by inventory identity rather than stack count. Receivers share compatible cargo equally, with whole-item leftovers rotating across phases. Processing machines retain existing-recipe preferences; storage chests no longer prefer cargo just because they received its first item. Full or incompatible receivers relinquish their shares. Existing face-specific fuel rules remain authoritative.
