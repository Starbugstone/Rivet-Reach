...
The subsequent [body and scene polish](BODY_AND_SCENE_POLISH_RESULTS.md) restores the torso in first person, keeps the open collar outside the camera and adds a complete shadow silhouette. Its report owns the revised first-person/shadow rendering cost and current scene visuals; the source model/clip counts above remain unchanged.
