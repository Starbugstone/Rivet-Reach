...
The refreshed export contains **190 items and 194 recipes**. Source validation passed **218 pages / 9,358 local links and images**. The dedicated [Spawn mechanics](../wiki/Spawn-mechanics.md) page explains natural hostiles, cages and persistent chickens, including floors, body sizes, light, 3D distances, attempts, independent caps, unloading and empty-room troubleshooting. Updated [Spawners](../wiki/Spawners.md), [Lava](../wiki/Lava.md), [Building and inventory](../wiki/Building-and-inventory.md), item pages and navigation include current native captures. [Wiki deployment 35442128542](https://github.com/Starbugstone/Rivet-Reach/actions/runs/35442128542) succeeded from source commit `4ec2909`, publishing wiki commit `c968bf3`. [Live Chromium review](alpha-playtest-2026-09-19/wiki-live-review.json) opened eight affected/reference pages successfully and loaded all **213 image references**. It followed the Spawn mechanics → Floater spawners link and checked the spawn guide at 1280 × 900 and 390 × 844, with no document overflow. All **ten new screenshot/icon assets** matched their local PNG hashes in [live asset verification](alpha-playtest-2026-09-19/wiki-assets.json).

[Desktop spawn guide](alpha-playtest-2026-09-19/wiki-spawn-mechanics-desktop.png), [mobile spawn guide](alpha-playtest-2026-09-19/wiki-spawn-mechanics-mobile.png) and [live spawner guide](alpha-playtest-2026-09-19/wiki-spawners-desktop.png) retain the rendered review. The published [Spawn mechanics page](https://github.com/Starbugstone/Rivet-Reach/wiki/Spawn-mechanics) is linked from the main navigation and relevant creature guides. [Issue state readback](alpha-playtest-2026-09-19/issue-state.json) confirms #12 closed as completed after these checks.
