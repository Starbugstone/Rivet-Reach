...
Recipe balance and long-session play quality still need user play review. Station/crop/world state is **session-only**, and quitting resets it. Tool/armor wear, fitted armor meshes, irrigation, enchantments, animal farming and durable saves remain unimplemented. [Current starter crafting verification](CRAFTING_RESULTS.md) records exact recipe layouts and the placed-workbench interaction flow.
