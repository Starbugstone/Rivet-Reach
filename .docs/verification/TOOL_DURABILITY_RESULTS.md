...
The final Unity export contains **195 items / 199 recipes**, with **230 pages / 9,925 local link and image checks** passing. All **686 exported source fingerprints** match committed source `712592b`, resolving Git LFS identities. The unrelated pre-existing dirty terrain atlas was preserved, temporarily replaced with its committed version for build/export, then restored byte-for-byte after validation; it was not included in these commits.

[Deployment 35462602999](https://github.com/Starbugstone/Rivet-Reach/actions/runs/35462602999) succeeded from combined catalog commit `7c65260`. Live Chromium review loaded the illustrated guide, wood/diamond pickaxes and axes, wrench, fishing rod and Home, with all images loaded and no horizontal overflow at 390×844. [Browser results](tools-durability-2026-09-19/live-wiki-checks.json), [desktop guide](tools-durability-2026-09-19/wiki-Tools-and-durability-desktop.png), [diamond recipe](tools-durability-2026-09-19/wiki-Item-diamond-pickaxe-desktop.png) and [mobile guide](tools-durability-2026-09-19/wiki-tools-mobile.png) retain the checks. Initial navigation before deployment cached GitHub's missing-page redirect; the successful post-deployment review used a commit-specific query parameter.

The [published guide](https://github.com/Starbugstone/Rivet-Reach/wiki/Tools-and-durability) shows both actual in-game durability captures. Food's live-page review is owned by its coordinated verification report.
