...
The isolated candidate’s actual Unity export, player notes and generated pages pass **146 pages / 6,076 local links and images** through `Tools/publish_wiki.py --check`. This isolated validation preserves unfinished unrelated wiki edits in the shared workspace. Chromium reviewed the GitHub-rendered item page with all 20 images loaded, plus the setup guide at 390 px without horizontal overflow. Deployment and live rendering are recorded below after publication.
