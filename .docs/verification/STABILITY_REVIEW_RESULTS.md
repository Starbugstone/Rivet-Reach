...
The earlier broad regression and mob captures above retain their original build identity. This focused follow-up supersedes their immature-potato expectation without claiming those full suites ran again. The guide and potato/stage item pages now explain eating one immediately versus growing extra potatoes, and issue #10 records the explicit potato exception. [Deployment 34754429710](https://github.com/Starbugstone/Rivet-Reach/actions/runs/34754429710) succeeded for follow-up commit `dd0bc33`; live Chromium verified the one-potato/eat-or-replant rule and 2–4 mature yield on all five affected pages, with all 17 content images loaded. [Deployment metadata](stability-2026-09-13/potato-clarification/wiki-deployment.json), [live page and issue checks](stability-2026-09-13/potato-clarification/wiki-live-review.json), [published potato-stage page](stability-2026-09-13/wiki-live-potato-clarification.png).
