...
No terrain-generation changes are needed. Crates, weather and renewable power remain separate increments. See the [illustrated player guide](wiki/Beds-and-home-spawn.md) and [measured evidence](verification/BED_RESULTS.md).
